            ...
            try {
                ...
                yield response.map((item) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (data.currency != 'No') {
                        ...
                        item.date = new Date();
                        item.url = `https://vintagevtg.com${item.url}`;
                        if (id == null)
                ...
                logger_1.logger.info(`vintage complete with ${invs.length}`);
                return invs;
            }
            catch (error) {
                logger_1.logger.error(`vintage ${error}`);
                return [];
            }
        });
    }
...
//# sourceMappingURL=vintagevtg.js.map