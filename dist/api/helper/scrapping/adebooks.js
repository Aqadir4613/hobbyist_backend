            ...
            try {
                ...
                yield response.map((item) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (data.currency != 'No') {
                        ...
                        item.date = new Date();
                        item.url = `https://www.abebooks.com${item.url}`;
                        if (id == null)
                ...
                logger_1.logger.info(`adebooks complete with ${invs.length}`);
                return invs;
            }
            catch (error) {
                logger_1.logger.error(`Adebooks ${error}`);
                return [];
            }
        });
    }
...
//# sourceMappingURL=adebooks.js.map