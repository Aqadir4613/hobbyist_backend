            ...
            try {
                ...
                yield response.map((item) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (data.currency != 'No') {
                        ...
                        item.date = new Date();
                        item.url = `https://steinersports.com${item.url}`;
                        if (id == null)
                ...
                logger_1.logger.info(`steiner complete with ${invs.length}`);
                return invs;
            }
            catch (error) {
                logger_1.logger.error(`steiner ${error}`);
                return [];
            }
        });
    }
...
//# sourceMappingURL=steinersports.js.map